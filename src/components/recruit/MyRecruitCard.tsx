	...
	return (
		<div className='flex flex-wrap justify-center'>
			{mySearchResults.map((result) => (
				<div
					key={result.id}
					className='relative bg-gray-100 w-64 h-auto grid place-items-center border-black border-2 m-3'
				>
					...
					<img
						src={result.projectImgUrl || 'default-thumbnail-url'}
						alt='Project Thumbnail'
						className='w-56 h-40 bg-sub-color'
					/>
