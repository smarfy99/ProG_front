			...
			<div className='flex'>
				...
				<div className='flex flex-col items-start mr-10'>
					<div className='flex items-center mb-4'>
						...
						<FaPencil size='28' onClick={toggleEditMode} className='cursor-pointer text-gray-500' />
					</div>
					{isEditMode && (
						<button
				...
				<div className='flex-1'>
					...
					<div className='flex items-center mb-4'>
						<div>
							...
							<input type='password' className='w-80 p-2 border border-gray-300 rounded' />
						</div>
						<button
							onClick={toggleModal}
				...
				<div className='flex-1 flex-col'>
					...
					<div>
						...
						<p className='font-mainFont mb-4'>사용 중인 기술이나 관심있는 기술을 선택해주세요</p>
						<TechStack />
					</div>
				</div>
