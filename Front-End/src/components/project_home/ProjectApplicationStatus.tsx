...
const ProjectApplicationStatus: React.FC<Props> = ({
    ...
    useEffect(() => {
        console.log(`받은 멤버 데이터 : ${JSON.stringify(memberDataList)}`)
                                ...
                                <li key={index} className={'flex justify-center'}>
                                    <div className={'app-member-card p-5 text-xl'}>
                                        <div className={'app-member-img-box '}>
                                            <div>
                                                <ImageWithFallback src={`${member.member.imgUrl}`} alt={''}
                                                                   type={'member'}/>
                                            </div>
                                            <div>
                                        ...
                                        <div className={'flex justify-between'}>
                                            <button className={'app-home-btn'}
                                                    onClick={() => accept(member.member.id)}>승인
                                            </button>
                                            <button className={'app-home-btn'}
                                                    onClick={() => refuse(member.member.id)}>거절
                                            </button>
                                        </div>
                                    </div>
                                </li>
