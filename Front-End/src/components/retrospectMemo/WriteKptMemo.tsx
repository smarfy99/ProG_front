          ...
          <div className="bg-white p-5 rounded-lg shadow-lg w-11/12 max-w-2xl">
            <div className="flex">
              <div
                className={`flex-1 p-4 cursor-pointer ${
                  selectedSection === "Keep" ? "bg-sub-color" : ""
                }`}
              ...
              <div
                className={`flex-1 p-4 cursor-pointer ${
                  selectedSection === "Problem" ? "bg-sub-color" : ""
                }`}
              ...
              <div
                className={`flex-1 p-4 cursor-pointer ${
                  selectedSection === "Try" ? "bg-sub-color" : ""
                }`}
            ...
            <div className="flex justify-center mt-4">
              ...
              <button
                ...
                onClick={() => closeModalAndClearText()}
              >
                닫기
              </button>
            </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-20">
          <div className="bg-white p-5 rounded-lg shadow-lg max-w-sm mx-auto">
            ...
            <p className="text-sm text-gray-500">
              선택한 섹션으로 변경하면 현재 작성 중인 내용이 초기화됩니다.
              계속하시겠습니까?
            </p>
