                            ...
                            <div>
                                <Link to={`recruit/project/${project.id}`} className={'project-card'}>
                                    <div className={'tag-box'}>
                                        ...
                                        <div
                                            className={project.statusCode.detailName === "Proceeding" ? 'recruitment-completed' : 'recruiting'}>
                                            {
                                                project.statusCode.detailName === "Proceeding" ?
                                                    <p>✔ 모집완료</p> : <p>🚨 모집중</p>
                                            }
                                        </div>
                                    </div>
                                    <div className={'dead-line'}>
                                        <p>생성일 | <span>{project.createdAt}</span></p>
                                    </div>
                                    <h1>{project.title}</h1>
                                    <div>
