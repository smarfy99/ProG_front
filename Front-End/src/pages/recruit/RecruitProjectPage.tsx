          ...
          <div className='h-auto shadow-xl rounded-3xl p-5'>
            ...
            <div className='flex justify-between m-5'>
              ...
              <div className='flex-col w-3/12 h-52'>
                ...
                <div className='bg-sub-color h-24 rounded-lg p-2'> 총 인원
                  <div className='text-center text-3xl mt-3'>{number} 명</div>
                </div>
              </div>
            </div>
            <div className='ml-3 text-3xl mt-10'>
              기술스택
            </div>
            ...
            <div className=' m-5 flex justify-center'>
              ...
              <div className={`bg-gray-50 m-5 w-32 h-28 rounded-3xl p-2 cursor-pointer ${isLike === 1 ? 'bg-sub-color' : ''}`} onClick={toggleLike}>
                <div className='flex justify-center'>
